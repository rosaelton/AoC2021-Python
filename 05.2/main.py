    ...
    for vent in vents:
        ...
        # Check for horizontal line
            ...
            if vent[0][0] < vent[1][0]:
                ...
                step = -1
            straight_line = [(x, vent[0][1]) for x in range(vent[0][0], vent[1][0] + step, step)]
        ...
        # Check for vertical line
            ...
            straight_line = [(vent[0][0], y) for y in range(vent[0][1], vent[1][1] + step, step)]
